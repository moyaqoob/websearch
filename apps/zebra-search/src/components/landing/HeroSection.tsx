  ...
  return (
    <div className={styles.hero}>
      <div className={styles.inner}>
        ...
        <h1
          className={`${styles.title} fade-up`}
        ...
        >
          A search engine built for DSA, algorithms, and system design. No SEO
          junk. No sponsored results. Just signal.
        </p>

        <div
          className={`${styles.searchWrap} fade-up`}
        ...
        <div
          className={`${styles.hints} fade-up`}
        ...
        >
          ...
          {SEARCH_HINTS.map((h) => (
            <span
              key={h}
              className={`${styles.hintChip} hint-chip`}
              onClick={() => setQuery(h)}
            >
              {h}
            </span>
